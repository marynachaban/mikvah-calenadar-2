...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    (async () => {
      const { data } = await axios.get("https://mikvah-back-bc1cfa0e6730.herokuapp.com/config", {
        headers: {
  ...
  useEffect(() => {
    (async () => {
      const { data } = await axios.get("https://mikvah-back-bc1cfa0e6730.herokuapp.com/zmanim")
